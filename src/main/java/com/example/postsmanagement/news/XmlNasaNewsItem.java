...
public class XmlNasaNewsItem implements NewsItem{
    ...
    public XmlNasaNewsItem() {
    }

    public XmlNasaNewsItem(String title, String link, String description) {
        this.title = title;
        this.link = link;
    ...
    public boolean equals(Object o) {
        ...
        XmlNasaNewsItem that = (XmlNasaNewsItem) o;
